...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/register-login-style.css">
...
<div class="register col-12">
    <form action="php_scripts/user/add_user.php" method="POST">
        <div class="register-panel">
            <div class="register-header">Rejestracja</div>
            <input name="login"    class="sign-input" type="text"     min="3" max="15" placeholder="Login" required>
            <input name="password" class="sign-input" type="password" min="3" max="30" placeholder="Hasło"  required>
            <button type="submit" class="register-submit">Zatwierdź</button>
        </div>
    </form>
</div>
